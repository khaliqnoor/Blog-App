        ...
        <div className="bg-white shadow-lg rounded-xl p-6 md:p-10 flex flex-col md:flex-row gap-8 items-center border">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              A passionate learner and creator who's deep into tech,
              freelancing, web development, and building meaningful digital
              experiences. I use this blog to share ideas, tutorials, and
              lessons I learn along the way — raw, honest, and hopefully
              helpful.
            </p>
          </div>
        </div>
