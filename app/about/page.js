        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* {recentBlogs.map((blog) => ( */}
            <div  className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">AI-New Electricity</h3>
                <p className="text-gray-600 mb-4">AI is changing the way we are living adn this is not just the optimistic approach but can be done</p>
                <Link
                  href='/#'
                  // `/blog/${blog.id}`
